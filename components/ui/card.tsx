...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-surface text-foreground flex flex-col gap-4 rounded-[24px] border border-border shadow-soft p-5",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-tight font-bold text-base text-text-main", className)}
      {...props}
    />
  );
}
